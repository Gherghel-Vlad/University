...
//    cout << "Result for sum of doubles -1.5 and 2.6 is: " << resDouble << endl;
//
...
//    cout << "Result for sum of 2D vectors (1, 2) and (-1, 2) is: (" << resVector2D.getXCoordinate() << ", "
//         << resVector2D.getYCoordinate() << ")" << endl;
//    return 0;
//}
...
namespace iterator {
    ...
    public:
        ...
        Castle(std::string desc, std::string picture, std::string loc, int startPr, int lastBiddingPr) : description{
                desc}, photo{picture}, location{loc}, startPrice{startPr}, lastBidPrice{lastBiddingPr} {}

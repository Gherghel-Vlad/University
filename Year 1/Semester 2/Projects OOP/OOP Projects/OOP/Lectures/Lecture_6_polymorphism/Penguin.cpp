...
namespace polymorphism {
    Penguin::Penguin(std::string _colour, double _weight, std::string _type) : Animal{_colour, _weight}, type{_type} {
        cout << "Constructing a " << this->type << " penguin, weighting " << this->weight
             << " kg and having the colours: " << this->colour << "." << endl;
    }

    Penguin::~Penguin() {
        cout << this->type << " penguin, weighting " << this->weight << " kg and having the colours : " << this->colour

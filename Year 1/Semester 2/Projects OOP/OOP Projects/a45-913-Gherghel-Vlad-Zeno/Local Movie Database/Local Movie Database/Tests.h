...
private:
	...
	void testDynamicVectorClassCreation();

	void testDynamicVectorClassOperatorSquareBrackets();

	void testDynamicVectorClassDelete();

	void testDynamicVectorClassUpdate();

	void testDynamicVectorClassgetIndexOfElement();

	void testDynamicVectorClassGetAllElements();

	void testDynamicVectorClassOperatorAssign();

	void testDynamicVectorClassGetSize();

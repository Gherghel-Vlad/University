...
public:
	UndoRedoService* undoRedoService = nullptr;

	// constructor that gets the movies repo to work on
	AdministratorService(MoviesRepository& mr);
	...
	void addMovie(Movie movie, bool calledFromUndoRedoService = false);
	...
	void deleteMovieFromPosition(int pos, bool calledFromUndoRedoService = false);
	...
	void updateMovieFromPositionn(Movie new_movie, int pos, bool calledFromUndoRedoService = false);
	...
	void deleteMovieWithTitle(string title, bool calledFromUndoRedoService = false);
	...
	void updateMovieWithTitle(Movie new_movie, string title, bool calledFromUndoRedoService = false);

...
segment  data use32 class=data ; the data segment where the variables are declared 
    ...
    b dw 40 ;AX = AH |AL -2bytes BX, CX, EAX (high part)
...
start: 
    ...
    div bl;
           ...
           mov al,[a]; [a] - it s value
           mov bx, a; a -  it s adress 
           mov bx, [b];
           mov ax, [a];
            mov eax, [a]; -> 0A 28 00 12 -> 4 -> little indian: eax: 12 00 28  0A
            mov ebx, [b]; -> 28 00 12 13 B1 (28 00 12 13) -> LI: 13 12 00 28

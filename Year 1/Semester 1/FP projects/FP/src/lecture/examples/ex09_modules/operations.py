...
# TODO Import statements should be at the top

'''
    Switch the order of the import statements below. What happens?
'''
# import src.lecture.examples.ex09_modules.rational.rational_dict as rational
# import src.lecture.examples.ex09_modules.rational.rational_list as rational
# print(rational.create_rational(1,3))

'''
    Code below works by directly referencing the create_rational function 
'''
from src.lecture.examples.ex09_modules.rational import rational_dict
from src.lecture.examples.ex09_modules.rational import rational_list
...
"""
# from src.lecture.examples.ex09_modules.rational.rational_dict import create_rational, get_numerator, get_denominator
from src.lecture.examples.ex09_modules.rational.rational_list import create_rational, get_numerator, get_denominator

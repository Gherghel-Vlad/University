from seminar.seminar_09_912.domain.Client import Client
from seminar.seminar_09_912.service.UndoService import Operation, FunctionCall
...
class ClientService:
    ...
    def delete(self, client_id):
        ...
        # Obs. Only undo operations that were successfully completed

...
from Library.data_structures.IterableDataStructure import gnome_sort
...
class RentalService:
    ...
    def return_book(self, book_id):
        ...
        redo = FunctionCall(self._repo.return_book, book_id, ret_date)

        self._undo_service.record(Operation(undo, redo))

        self._repo.return_book(book_id, ret_date)
    ...
    def most_rented_books(self):
        ...
        gnome_sort(result, lambda a, b: a.rented_times <= b.rented_times)
        return result
    ...
    def most_active_clients(self):
        ...
        gnome_sort(result, lambda a, b: a.rented_days <= b.rented_days)
        return result
    ...
    def most_rented_authors(self):
        ...
        gnome_sort(result, lambda a, b: a.rental_number <= b.rental_number)

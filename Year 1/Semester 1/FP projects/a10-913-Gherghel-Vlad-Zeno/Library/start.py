...
from Library.SQLRepository.BookSQLRepository import BookSQLRepository
from Library.SQLRepository.ClientSQLRepository import ClientSQLRepository
from Library.SQLRepository.CreatingDatabaseTables import create_database_and_tables
from Library.SQLRepository.RentalSQLRepository import RentalSQLRepository
...
elif settings.get_repository_type() == "database":
    create_database_and_tables(settings.get_database_path())
    book_repo = BookSQLRepository(settings.get_database_path())
    client_repo = ClientSQLRepository(settings.get_database_path())
    rental_repo = RentalSQLRepository(settings.get_database_path())
...
# Helper.add_clients(client_service)
# rental_repo.add_dummy_data()
# Helper.rent_books(rental_service)

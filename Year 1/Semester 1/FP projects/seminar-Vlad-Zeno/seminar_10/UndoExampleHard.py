...
@author: Arthur
"""
from seminar_10.domain.Car import CarValidator
from seminar_10.domain.Client import ClientValidator
from seminar_10.domain.Rental import RentalValidator
from seminar_10.repository.CarTextRepo import CarTextRepo
from seminar_10.repository.ClientTextRepo import ClientTextRepo
from seminar_10.repository.RentalTextRepo import RentalTextRepo
from seminar_10.service.CarService import CarService
from seminar_10.service.ClientService import ClientService
from seminar_10.service.RentalService import RentalService
from seminar_10.service.UndoService import UndoService
from seminar_10.util import print_repos_with_message


def undo_example_hard():
    undo_service = UndoService()
    client_repo = ClientTextRepo("client.txt")  # Repository()
    car_repo = CarTextRepo("car.txt")  # Repository()

    '''
    Start rental Service
    '''
    rent_repo = RentalTextRepo("rental.txt", client_repo, car_repo)  # Repository()

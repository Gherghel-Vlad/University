...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, IValue> symtbl, MyIList<IValue> o, MyIDictionary<StringValue, BufferedReader> fileTbl, MyIHeap heap, IStmt prg, MyISemaphore sem) throws MyException{
        this.exeStack = stk;
    ...
    public String toFileFormatString(){
        return  "Id: " + this.getIdPrgState() + "\n" +
                ...
                "Semaphore:\n" + this.semaphoreTofileFormatString() +
                "\n\n----------------------------------------------------------------------\n\n";
    }
    ...
    private String semaphoreTofileFormatString(){
        StringBuilder semTableStr = new StringBuilder();

        String str = this.semaphore.toString();
        str = str.replace("{", "");
        str = str.replace("}", "");
        str = str.replace(" ", "");
        str = str.replace("=", " --> ");
        ...
        for(String s : listStr){
            semTableStr.append(s).append("\n");
        }

        return semTableStr.toString();
    }

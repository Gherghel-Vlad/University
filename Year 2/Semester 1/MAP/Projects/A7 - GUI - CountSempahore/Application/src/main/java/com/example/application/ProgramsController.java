...
public class ProgramsController {
    ...
    public void initialize(){
        ...
        this.ex13 = new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())),
                new CompStmt(new VarDeclStmt("cnt", new IntType()),
                        new CompStmt(new NewStmt("v1", new ValueExp(new IntValue(1))),
                                new CompStmt(new CreateSemaphoreStmt("cnt", new rHExp(new VarExp("v1"))),
                                        new CompStmt(new forkStmt(new CompStmt(new AcquireStmt("cnt"), new CompStmt(new wHStmt("v1", new ArithExp('*', new rHExp(new VarExp("v1")), new ValueExp(new IntValue(10)))), new CompStmt(new PrintStmt(new rHExp(new VarExp("v1"))), new ReleaseStmt("cnt")))))
                                        , new CompStmt(new forkStmt(new CompStmt(new AcquireStmt("cnt"), new CompStmt(new wHStmt("v1", new ArithExp('*', new rHExp(new VarExp("v1")), new ValueExp(new IntValue(10)))), new CompStmt(new wHStmt("v1", new ArithExp('*', new rHExp(new VarExp("v1")), new ValueExp(new IntValue(2)))), new CompStmt(new PrintStmt(new rHExp(new VarExp("v1"))), new ReleaseStmt("cnt"))))))
        ...
        this.programsListViewId.getItems().add(this.ex13.toString());
        ...
        try {
            switch (selectedEx) {
                ...
                case 11:
                    ...
                    break;
                case 12:
                    this.ex13.typecheck(new MyDictionary<String, IType>());
                    createProgramStage(this.ex13.deepCopy(), "log13.txt");
                    break;
                default:

...
public class ProgramController {
    ...
    public void initData(IStmt s, String fileName){
        ...
        try {
            this.prg = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, IValue>(), new MyList<IValue>(), new MyDictionary<StringValue, BufferedReader>(), new MyHeap(), this.stmt, new MyLockTable());
    ...
    @FXML
    private TableView<LockTableModel> lockTableViewId;

    @FXML
    private TableColumn<LockTableModel, Integer> lockTableViewLocationColumnId;

    @FXML
    private TableColumn<LockTableModel, Integer> lockTableViewValueColumnId;
    ...
    public void initialize(){
        ...
        this.lockTableViewLocationColumnId.setCellValueFactory(new PropertyValueFactory<>("Location"));
        this.lockTableViewValueColumnId.setCellValueFactory(new PropertyValueFactory<>("Value"));
    ...
    private void clearEverything(){
        ...
        for ( int i = 0; i<this.lockTableViewId.getItems().size(); i++) {
            this.lockTableViewId.getItems().clear();
        }
    ...
    private void populateEverything(){
        ...
        try {
            ...
            for (Integer s : this.prg.getLockTable().getLockTable().getContent().keySet()) {
                this.lockTableViewId.getItems().add(new LockTableModel(s, this.prg.getLockTable().getLockTable().get(s)));
            }

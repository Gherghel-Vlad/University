                                        ...
                                        new CompStmt(new NewStmt("v1", new ValueExp(new IntValue(20))),
                                                new CompStmt(new NewStmt("v2", new ValueExp(new IntValue(30))),
                                                        new CompStmt(new NewLockStmt("x"),
                                                                new CompStmt(new forkStmt(new CompStmt(new forkStmt(new CompStmt(new LockStmt("x"), new CompStmt(new wHStmt("v1", new ArithExp('-', new rHExp(new VarExp("v1")), new ValueExp(new IntValue(1)))), new UnlockStmt("x"))))
                                                                , new CompStmt(new LockStmt("x"), new CompStmt(new wHStmt("v1", new ArithExp('*', new rHExp(new VarExp("v1")), new ValueExp(new IntValue(10)))), new UnlockStmt("x"))))),
                                                                        new CompStmt(new NewLockStmt("q"),
                                                                                new CompStmt(new forkStmt(new CompStmt(new forkStmt(new CompStmt(new LockStmt("q"), new CompStmt(new wHStmt("v2", new ArithExp('+', new rHExp(new VarExp("v2")), new ValueExp(new IntValue(5)))), new UnlockStmt("q")))),

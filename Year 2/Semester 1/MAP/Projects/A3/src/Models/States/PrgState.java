...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, IValue> symtbl, MyIList<IValue> o, MyIDictionary<StringValue, BufferedReader> fileTbl,IStmt prg) throws MyException{
        this.exeStack = stk;
